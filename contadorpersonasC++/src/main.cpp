...
/** \mainpage RoboComp::contadorpersonascpp
 *
 * \section intro_sec Introduction
 *
 * The contadorpersonascpp component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/contadorpersonascpp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class contadorpersonascpp : public RoboComp::Application
{
public:
	contadorpersonascpp (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::contadorpersonascpp::initialize()
{
...
int ::contadorpersonascpp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::contadorpersonascpp app(prefix);
